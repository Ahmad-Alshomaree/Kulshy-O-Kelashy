...
>(({ className, variant = "default", fullWidth = false, ...props }, ref) => {
  const variantStyles = {
    ...
    outline: "border border-input bg-transparent p-1 text-muted-foreground rounded-md",
    underline: "border-b border-input bg-transparent p-0 text-muted-foreground",
  }
